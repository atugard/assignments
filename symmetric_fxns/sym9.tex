...
\begin{proof}
  ...
  \end{align*}
  By our choice of $\lambda$ we have that for $\lambda \subsetneq \mu$, $c_\mu = 0$. If $\mu \subsetneq \lambda$, we have either $\lambda$ has a distinct part $\lambda_i$, and $\cfrac{\partial}{\partial p_{\lambda_i}}p_\mu = 0$, or $\lambda$ and $\mu$ have the same parts, but $\lambda$ has a greater multiplicity of at least one part and 
  \begin{align*}
