...
\begin{proof}
  ...
  If $\lambda$ and $\mu$ are not comparable under partition inclusion, then there's some $\lambda_i>\mu_i$, and 
  \begin{align*}
  ...
  \begin{align*}
    ...
    &=
    c_\lambda\prod\limits_{\lambda_i \text{distinct}} \lambda_i^{m_{\lambda_i}(\lambda)} m_{\lambda_i}(\lambda)! \\
    &=
