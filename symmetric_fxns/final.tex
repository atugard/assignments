...
\begin{proof}
  ...
  \begin{align*}
    ...
    (\sum\limits_{i} b_{i}\cfrac{1}{a_{\lambda^i}}p_{\lambda^i})^{\perp},
  \end{align*}
  where the sum is over $i=(i_1, \dots, i_k)$, with $i_1, \dots, i_k \geq 1$; and $k \in \N$, $a_{\lambda^i} = i_1 \cdots i_k$, and $b_{i} \in \Q$. Since $\sum\limits_{i} b_{i}\cfrac{1}{a_{\lambda^i}}p_{\lambda^i} \in Sym_{\Q}$, this $\Q$-linear combination from the right hand side is included in the left hand side.
\end{proof}
\newpage
\begin{exercise}
