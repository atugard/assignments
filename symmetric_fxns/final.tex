...
\begin{proof}
  ...
  \end{align*}
  where we used the commutativity of the counit diagram in the fourth equality. Identifying $af$ with $a \otimes f$, $f \otimes a$ (by $af \overset{\cong}{\mapsto} a \otimes f$ and $af \overset{\cong}{\mapsto} f \otimes a$) we conclude that
  \begin{align*}
