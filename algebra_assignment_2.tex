...
\begin{proof}
  ...
  \end{align*}
  Let $A:= R_p \setminus R_p^\times = \set{r \in R/pR: p \mid r \overline{r}}$, which is the set of zero divisors of $R_p$.
  Any element in this set generates a proper right $R_p$-submodule. Thus, we have
  \begin{align*}
    J(R_p) &= \bigcap \limits_{a \in A} \text{Ann}(aR_p) \\
    &= \bigcap \limits_{a \in A} \text{Ann}(aR_p) \\
  \end{align*}
\end{proof}
\end{document}
