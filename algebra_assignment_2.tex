...
\begin{proof}
  ...
  \begin{align*}
    R_p/J(R_p) =
    \begin{cases}
      \Z \oplus \Z i \oplus \Z j        & \text{ if } p = 2 \\
      \Z \oplus \Z i \oplus \Z j \oplus \Z k & \text { if } p \neq 2
    \end{cases}.
  \end{align*}
\end{proof}
\begin{exercise}
...
\begin{proof}
  Let $R = \mathbb{F}_3 S_3$. $R$ has 81 nilpotent elements. The following is nilpotent in $R$
  \begin{align*}
    \sigma = 2e + (23) + 2(123) + 2(132) + 2(13),
  \end{align*}
  and
  \begin{align*}
    I = \sigma \mathbb{F}_3S_3
  \end{align*}
  is a right ideal of $R$ such that $\abs{I} = 81$, that is $I$ contains all nilpotent elements of $R$, so it's a nil ideal of $R$. Thus
  \begin{align*}
    I \subseteq J(\mathbb{F}_3/S_3).
  \end{align*}
  From the character table of $S_3$ one finds the following central simple idempotents of $S_3$: 
  \begin{align*}
    e_1 &=  () + (123) + (132) + (12) + (13) + (23) \\
    e_2 &= () + (123) + (132) - (12) - (13) - 23) \\
    e_3 &= 2() - (123) - (132)
  \end{align*}
  One finds that $e_1 R$ and $e_2 R$ are simple right $R$-modules (and that $e_3 R$ is not). Moreover, one finds that 
  \begin{align*}
    I = Ann_R(e_1 R) \cap Ann_R(e_2 R).
  \end{align*}
  Since
  \begin{align*}
    J(\mathbb{F}_3/S_3) \subseteq Ann_R(e_1 R) \cap Ann_R(e_2 R),
  \end{align*}
  we conclude that 
  \begin{align*}
    J(\mathbb{F}_3/S_3) = Ann_R(e_1 R) \cap Ann_R(e_2 R).
  \end{align*}
  Using the chinese remainder theorem, we get
  \begin{align*}
    R/J(R) &\cong R/Ann_R(e_1R) \times R/Ann_R(e_2R) \\
