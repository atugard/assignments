...
\begin{proof}
  ...
  \end{align*}
  i.e. these are the quaternions mod $p$. We define $A= \set{r \in R_p: r \overline{r} = 0}$, and find $A = R_p \setminus R_p^x$.
  ...
  \end{align*}
  For $p \neq 2$, $Ann(aR_p) = \emptyset$, and so $J(R_p) = \emptyset$. For $p = 2$, we have
  \end{align*}
\end{proof}
\end{document}
